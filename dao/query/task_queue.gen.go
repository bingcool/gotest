...
func newTaskQueue(db *gorm.DB, opts ...gen.DOOption) taskQueue {
	...
	_taskQueue.taskQueueDo.UseModel(&gmodel.TaskQueue{})
...
func (t taskQueueDo) Create(values ...*gmodel.TaskQueue) error {
	if len(values) == 0 {
		return nil
	}
...
func (t taskQueueDo) CreateInBatches(values []*gmodel.TaskQueue, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t taskQueueDo) Save(values ...*gmodel.TaskQueue) error {
	if len(values) == 0 {
		return nil
	}
...
func (t taskQueueDo) First() (*gmodel.TaskQueue, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gmodel.TaskQueue), nil
	}
}

func (t taskQueueDo) Take() (*gmodel.TaskQueue, error) {
...
func (t taskQueueDo) Last() (*gmodel.TaskQueue, error) {
...
func (t taskQueueDo) Find() ([]*gmodel.TaskQueue, error) {
	result, err := t.DO.Find()
	return result.([]*gmodel.TaskQueue), err
}

func (t taskQueueDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gmodel.TaskQueue, err error) {
	buf := make([]*gmodel.TaskQueue, 0, batchSize)
...
func (t taskQueueDo) FindInBatches(result *[]*gmodel.TaskQueue, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t taskQueueDo) FirstOrInit() (*gmodel.TaskQueue, error) {
...
func (t taskQueueDo) FirstOrCreate() (*gmodel.TaskQueue, error) {
...
func (t taskQueueDo) FindByPage(offset int, limit int) (result []*gmodel.TaskQueue, count int64, err error) {
...
func (t taskQueueDo) Delete(models ...*gmodel.TaskQueue) (result gen.ResultInfo, err error) {
