...
func newTblOrder(db *gorm.DB, opts ...gen.DOOption) tblOrder {
	...
	_tblOrder.tblOrderDo.UseModel(&gmodel.TblOrder{})
...
func (t tblOrderDo) Create(values ...*gmodel.TblOrder) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tblOrderDo) CreateInBatches(values []*gmodel.TblOrder, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tblOrderDo) Save(values ...*gmodel.TblOrder) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tblOrderDo) First() (*gmodel.TblOrder, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gmodel.TblOrder), nil
	}
}

func (t tblOrderDo) Take() (*gmodel.TblOrder, error) {
...
func (t tblOrderDo) Last() (*gmodel.TblOrder, error) {
...
func (t tblOrderDo) Find() ([]*gmodel.TblOrder, error) {
	result, err := t.DO.Find()
	return result.([]*gmodel.TblOrder), err
}

func (t tblOrderDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gmodel.TblOrder, err error) {
	buf := make([]*gmodel.TblOrder, 0, batchSize)
...
func (t tblOrderDo) FindInBatches(result *[]*gmodel.TblOrder, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tblOrderDo) FirstOrInit() (*gmodel.TblOrder, error) {
...
func (t tblOrderDo) FirstOrCreate() (*gmodel.TblOrder, error) {
...
func (t tblOrderDo) FindByPage(offset int, limit int) (result []*gmodel.TblOrder, count int64, err error) {
...
func (t tblOrderDo) Delete(models ...*gmodel.TblOrder) (result gen.ResultInfo, err error) {
