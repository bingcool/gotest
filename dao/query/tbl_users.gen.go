...
func newTblUser(db *gorm.DB, opts ...gen.DOOption) tblUser {
	...
	_tblUser.tblUserDo.UseModel(&gmodel.TblUser{})
...
func (t tblUserDo) Create(values ...*gmodel.TblUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tblUserDo) CreateInBatches(values []*gmodel.TblUser, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tblUserDo) Save(values ...*gmodel.TblUser) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tblUserDo) First() (*gmodel.TblUser, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gmodel.TblUser), nil
	}
}

func (t tblUserDo) Take() (*gmodel.TblUser, error) {
...
func (t tblUserDo) Last() (*gmodel.TblUser, error) {
...
func (t tblUserDo) Find() ([]*gmodel.TblUser, error) {
	result, err := t.DO.Find()
	return result.([]*gmodel.TblUser), err
}

func (t tblUserDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gmodel.TblUser, err error) {
	buf := make([]*gmodel.TblUser, 0, batchSize)
...
func (t tblUserDo) FindInBatches(result *[]*gmodel.TblUser, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tblUserDo) FirstOrInit() (*gmodel.TblUser, error) {
...
func (t tblUserDo) FirstOrCreate() (*gmodel.TblUser, error) {
...
func (t tblUserDo) FindByPage(offset int, limit int) (result []*gmodel.TblUser, count int64, err error) {
...
func (t tblUserDo) Delete(models ...*gmodel.TblUser) (result gen.ResultInfo, err error) {
