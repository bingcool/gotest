...
func newBookQueue(db *gorm.DB, opts ...gen.DOOption) bookQueue {
	...
	_bookQueue.bookQueueDo.UseModel(&entity.BookQueue{})
...
func (b bookQueueDo) Create(values ...*entity.BookQueue) error {
	if len(values) == 0 {
		return nil
	}
...
func (b bookQueueDo) CreateInBatches(values []*entity.BookQueue, batchSize int) error {
	return b.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (b bookQueueDo) Save(values ...*entity.BookQueue) error {
	if len(values) == 0 {
		return nil
	}
...
func (b bookQueueDo) First() (*entity.BookQueue, error) {
	if result, err := b.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*entity.BookQueue), nil
	}
}

func (b bookQueueDo) Take() (*entity.BookQueue, error) {
...
func (b bookQueueDo) Last() (*entity.BookQueue, error) {
...
func (b bookQueueDo) Find() ([]*entity.BookQueue, error) {
	result, err := b.DO.Find()
	return result.([]*entity.BookQueue), err
}

func (b bookQueueDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.BookQueue, err error) {
	buf := make([]*entity.BookQueue, 0, batchSize)
...
func (b bookQueueDo) FindInBatches(result *[]*entity.BookQueue, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (b bookQueueDo) FirstOrInit() (*entity.BookQueue, error) {
...
func (b bookQueueDo) FirstOrCreate() (*entity.BookQueue, error) {
...
func (b bookQueueDo) FindByPage(offset int, limit int) (result []*entity.BookQueue, count int64, err error) {
...
func (b bookQueueDo) Delete(models ...*entity.BookQueue) (result gen.ResultInfo, err error) {
