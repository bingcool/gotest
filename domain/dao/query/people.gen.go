...
func newPerson(db *gorm.DB, opts ...gen.DOOption) person {
	...
	_person.personDo.UseModel(&entity.Person{})
...
func (p personDo) Create(values ...*entity.Person) error {
	if len(values) == 0 {
		return nil
	}
...
func (p personDo) CreateInBatches(values []*entity.Person, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p personDo) Save(values ...*entity.Person) error {
	if len(values) == 0 {
		return nil
	}
...
func (p personDo) First() (*entity.Person, error) {
...
func (p personDo) Take() (*entity.Person, error) {
...
func (p personDo) Last() (*entity.Person, error) {
...
func (p personDo) Find() ([]*entity.Person, error) {
	result, err := p.DO.Find()
	return result.([]*entity.Person), err
}

func (p personDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.Person, err error) {
	buf := make([]*entity.Person, 0, batchSize)
...
func (p personDo) FindInBatches(result *[]*entity.Person, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p personDo) FirstOrInit() (*entity.Person, error) {
...
func (p personDo) FirstOrCreate() (*entity.Person, error) {
...
func (p personDo) FindByPage(offset int, limit int) (result []*entity.Person, count int64, err error) {
...
func (p personDo) Delete(models ...*entity.Person) (result gen.ResultInfo, err error) {
