...
func newTblOrder(db *gorm.DB, opts ...gen.DOOption) tblOrder {
	...
	_tblOrder.tblOrderDo.UseModel(&entity.TblOrder{})
...
func (t tblOrderDo) Create(values ...*entity.TblOrder) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tblOrderDo) CreateInBatches(values []*entity.TblOrder, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tblOrderDo) Save(values ...*entity.TblOrder) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tblOrderDo) First() (*entity.TblOrder, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*entity.TblOrder), nil
	}
}

func (t tblOrderDo) Take() (*entity.TblOrder, error) {
...
func (t tblOrderDo) Last() (*entity.TblOrder, error) {
...
func (t tblOrderDo) Find() ([]*entity.TblOrder, error) {
	result, err := t.DO.Find()
	return result.([]*entity.TblOrder), err
}

func (t tblOrderDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.TblOrder, err error) {
	buf := make([]*entity.TblOrder, 0, batchSize)
...
func (t tblOrderDo) FindInBatches(result *[]*entity.TblOrder, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tblOrderDo) FirstOrInit() (*entity.TblOrder, error) {
...
func (t tblOrderDo) FirstOrCreate() (*entity.TblOrder, error) {
...
func (t tblOrderDo) FindByPage(offset int, limit int) (result []*entity.TblOrder, count int64, err error) {
...
func (t tblOrderDo) Delete(models ...*entity.TblOrder) (result gen.ResultInfo, err error) {
