...
func newCreditCard(db *gorm.DB, opts ...gen.DOOption) creditCard {
	...
	_creditCard.creditCardDo.UseModel(&entity.CreditCard{})
...
func (c creditCardDo) Create(values ...*entity.CreditCard) error {
	if len(values) == 0 {
		return nil
	}
...
func (c creditCardDo) CreateInBatches(values []*entity.CreditCard, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c creditCardDo) Save(values ...*entity.CreditCard) error {
	if len(values) == 0 {
		return nil
	}
...
func (c creditCardDo) First() (*entity.CreditCard, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*entity.CreditCard), nil
	}
}

func (c creditCardDo) Take() (*entity.CreditCard, error) {
...
func (c creditCardDo) Last() (*entity.CreditCard, error) {
...
func (c creditCardDo) Find() ([]*entity.CreditCard, error) {
	result, err := c.DO.Find()
	return result.([]*entity.CreditCard), err
}

func (c creditCardDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.CreditCard, err error) {
	buf := make([]*entity.CreditCard, 0, batchSize)
...
func (c creditCardDo) FindInBatches(result *[]*entity.CreditCard, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c creditCardDo) FirstOrInit() (*entity.CreditCard, error) {
...
func (c creditCardDo) FirstOrCreate() (*entity.CreditCard, error) {
...
func (c creditCardDo) FindByPage(offset int, limit int) (result []*entity.CreditCard, count int64, err error) {
...
func (c creditCardDo) Delete(models ...*entity.CreditCard) (result gen.ResultInfo, err error) {
