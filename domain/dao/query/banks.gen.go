...
func newBank(db *gorm.DB, opts ...gen.DOOption) bank {
	...
	_bank.bankDo.UseModel(&entity.Bank{})
...
func (b bankDo) Create(values ...*entity.Bank) error {
	if len(values) == 0 {
		return nil
	}
...
func (b bankDo) CreateInBatches(values []*entity.Bank, batchSize int) error {
	return b.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (b bankDo) Save(values ...*entity.Bank) error {
	if len(values) == 0 {
		return nil
	}
...
func (b bankDo) First() (*entity.Bank, error) {
	if result, err := b.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*entity.Bank), nil
	}
}

func (b bankDo) Take() (*entity.Bank, error) {
...
func (b bankDo) Last() (*entity.Bank, error) {
...
func (b bankDo) Find() ([]*entity.Bank, error) {
	result, err := b.DO.Find()
	return result.([]*entity.Bank), err
}

func (b bankDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entity.Bank, err error) {
	buf := make([]*entity.Bank, 0, batchSize)
...
func (b bankDo) FindInBatches(result *[]*entity.Bank, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (b bankDo) FirstOrInit() (*entity.Bank, error) {
...
func (b bankDo) FirstOrCreate() (*entity.Bank, error) {
...
func (b bankDo) FindByPage(offset int, limit int) (result []*entity.Bank, count int64, err error) {
...
func (b bankDo) Delete(models ...*entity.Bank) (result gen.ResultInfo, err error) {
